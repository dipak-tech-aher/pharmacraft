...

                                                {
                                                    (renderMode.accountDetails === 'form') ?
                                                        <div className="d-flex justify-content-end">
                                                            ...
                                                            <button type="button" className="btn btn-outline-primary text-primary btn-sm  waves-effect waves-light ml-2" onClick={handleAccountDetailsDone}>Done</button>
                                                        </div>
                                                        :
                                                        <></>
                                                }
                                                ...
                                                }
                                                {
                                                    (renderMode.accountDetails === 'view' && renderMode.accountDetailsEditButton === 'show') ?
                                                        <div className="d-flex justify-content-end edit-btn">
                                                            <button type="button" className="btn btn-outline-primary text-primary btn-sm  waves-effect waves-light ml-2" onClick={handleAccountDetailsEdit}>Edit</button>
                                                        </div>
                                                        :
                                                        <></>
                                                }
