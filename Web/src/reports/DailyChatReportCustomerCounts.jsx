...
import { customerCountsReportColumns, chatReporHiddenColumns } from './chatReportColumns';
import moment from "moment";

const DailyChatReportCustomerCounts = (props) => {
    const initialValues = {
    ...
    const getLoginDetails = () => {
        ...
        post(`${properties.REPORTS_API}/chat-daily-report-counts?limit=${perPage}&page=${currentPage}`, requestBody)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="col-12 row">
                                <div className="col-12"><h4 className="pl-3">Visit Count & Connected To Live Agent Chat Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                listKey={"Daily Chat Customer Report Count"}
                                                row={searchData}
                                                rowCount={totalCount}
                                                header={customerCountsReportColumns}
...
export default DailyChatReportCustomerCounts;