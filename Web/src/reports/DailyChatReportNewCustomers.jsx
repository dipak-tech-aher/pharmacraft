...
import { dailyNewCustomerRequestsChatReportColumns, chatReporHiddenColumns } from './chatReportColumns';
import moment from 'moment'

const DailyChatReportNewCustomers = (props) => {
    const initialValues = {
    ...
    const getLoginDetails = () => {
        ...
        post(`${properties.REPORTS_API}/chat-daily-report-new-customer-req?limit=${perPage}&page=${currentPage}`, requestBody)
            .then((resp) => {
                if (resp.data) {
                    if (resp.status === 200) {
                    ...
                    <div className="col-12">
                        <section className="triangle">
                            <div className="col-12 row">
                                <div className="col-12"><h4 className="pl-3">New Customer Requests Chat Report</h4></div>
                            </div>
                        </section>
                    </div>
                </div>
                                    ...
                                    <div className="card-body" id="datatable">
                                        <div style={{}}>
                                            <DynamicTable
                                                ...
                                                listKey={"Daily New Customer Requests Chat Report"}
                                                row={searchData}
                                                rowCount={totalCount}
                                                header={dailyNewCustomerRequestsChatReportColumns}
...
export default DailyChatReportNewCustomers;